...
urlpatterns = [
    ...
    url(r'^clothes/user=(?P<userID>[0-9]+)/', views.AllClothesOfUser.as_view()),
    ...
    url(r'^replies/mxm=(?P<mxmID>[0-9]+)/$', views.AllRepliesOfMxM.as_view()),
    ...
    url(r'^ratings/mxm=(?P<mxmID>[0-9]+)/$', views.AllRatingsOfMxM.as_view()),
